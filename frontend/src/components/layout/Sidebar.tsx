...
const navigation = [
  ...
  { name: 'Personal', href: '/employees', icon: '👥' },
  { name: 'Activos', href: '/assets', icon: '🔧' },
  { name: 'Proyectos', href: '/projects', icon: '🏗️' },
  { name: 'Eventos', href: '/events', icon: '⚠️' },
  { name: 'Combustible', href: '/fuel', icon: '⛽' },
  { name: 'GPS', href: '/gps', icon: '📍' },
  { name: 'Cámaras', href: '/cameras', icon: '📹' },
  { name: 'RFID', href: '/rfid', icon: '🏷️' },
  { name: 'Voz', href: '/voice', icon: '🎤' },
